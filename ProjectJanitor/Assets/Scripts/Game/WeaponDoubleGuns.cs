    ...
    public class WeaponDoubleGuns : MonoBehaviour
    {
        ...
        public void Fire()
        {
            if (CheckMagazine())
            {
                ...
                else
                {
                    ...
                    Instantiate(bullet, chokes2.transform.position, chokes2.transform.rotation);
                    magazine--;
                }
        ...
        public void ReloadMagazine()
        {
            if (magazine < magazineSize)
            {
                ...
                Debug.Log("Magazine is fulled up of ammo, stupid player, i'm in ReloadMagazine() of WeaponDoubleGun");
        }
    } 
}
